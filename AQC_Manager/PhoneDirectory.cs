...
namespace AQC_Manager
{
    public partial class phoneDirectory : Form
    {
        ...
        private void loadEmployees()
        {
            ...
            String sql = "SELECT employee_id AS 'Employee ID', name AS 'Name',mobile as 'Mobile Number', emergency as 'Emergency Contact',homeTel as 'Home Contact' FROM aqc_manager.employees";
